...
@Composable
fun WithdrawFundHistoryScreen(navController: NavController) {
    ...
    var historyList by remember { mutableStateOf(listOf<WithdrawRequest>()) }
    ...
    Scaffold(
        ...
        Column(
            ...
            Card(
                colors = CardDefaults.cardColors(containerColor = Color(0xFFADB4BE)),
                ...
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    Row(
                        ...
                        Button(
                            ...
                            Text(text = if (fromDate.isEmpty()) "From Date" else fromDate, color = Color.Black)
                        }
                        ...
                        Button(
                            ...
                            Text(text = if (toDate.isEmpty()) "To Date" else toDate, color = Color.Black)
                        }
                    }
                    Row(
                        modifier = Modifier.fillMaxWidth(),
                                ...
                                db.collection("withdraw_requests")
                                    ...
                                    .addOnSuccessListener { result ->
                                        ...
                                        val filtered = result.documents.mapNotNull { doc ->
                                            val dateStr = doc.getString("requestDate") ?: return@mapNotNull null
                                            try {
                                                ...
                                                null // Skip invalid date entries
                                            }
